<!-- Mobile Nav (max width 767px)-->
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="index.php"><img src="/furniture/myAssets/amado/img/core-img/logo.png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
...
?>><a href="/furniture/index.php">Home</a></li>
...
?>><a href="/furniture/dashboardRedirector.php">Account</a></li>
    ...
    ?>><a href="/furniture/cart.php">Cart</a></li> <?php }?>
    ...
    ?>
                        <li> <a href="/furniture/index.php?logout='1'" style="color: red;">logout</a> </li>
                    <?php }?>
                </ul>
            </nav>
        </header>
